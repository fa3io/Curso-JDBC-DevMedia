...
public class LoginFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\workspace\\Curso JDBC DevMedia\\img\\cadeado.png")); // NOI18N
        ...
        setSize(new java.awt.Dimension(332, 199));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void btnOkActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOkActionPerformed
        Login login = new Login(txtlogin.getText(), new String(txtSenha.getPassword()));

        LoginBO loginBO = new LoginBO();
        try {
            if (loginBO.logar(login)) {
                LoginFrame.this.dispose();
                MainFrame mainFrame = new MainFrame();
                mainFrame.setVisible(true);
            } else {
                MensagemUtil.adMesg(LoginFrame.this, "Dados Invalidos!!!");
            }
        } catch (NegocioException e) {
            e.printStackTrace();
            MensagemUtil.adMesg(LoginFrame.this, e.getMessage());
        }
